# DMS settings exported from ~/.config/DankMaterialShell/settings.json.bak
# Managed declaratively via Nix – edit here, then home-manager switch
{
  # Theme & colors
  ...
  # Additional settings from live config
  enableNotes = true;
